...
public class Intern extends Candidate {
    ...
    public void create(List<Candidate> list) {
        super.create(list);
        this.major = Validate.getString("Enter education: ", "[a-zA-Z ]+");
        this.semester = Validate.getInt("Enter semester: ", "Semester is a positive integer", 1, Integer.MAX_VALUE);
        this.university = Validate.getString("Enter education: ", "[a-zA-Z ]+");
    }
